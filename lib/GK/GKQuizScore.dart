            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(ua, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                ),
                SizedBox(height: 10,),
                Text("Correct answer: ", style: TextStyle(fontSize: 12),),
                Container(
                  decoration: BoxDecoration(
                  ...
                  padding: EdgeInsets.all(10),
                  margin: EdgeInsets.all(5),
                  child: Text(a, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                ),
                Text("Explanation: ", style: TextStyle(fontSize: 12),),
                Text(h, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500,),)
              ],
            ),
          )
        );
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 40,),
              Text("Your Score is ${correct}/${total}", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700,),),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: Results,
              )
